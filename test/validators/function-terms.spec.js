    ...
    describe('#factory', function() {
      ...
      describe('object', function() {
        ...
        describe('#fix', function() {
          ...
          it('Should be able to handle "esitt."-type terms', function() {
            ...
            var record_modified = new MarcRecord({
              fields: [{
                tag: '700',
                subfields: [
                  {
            ...
            record_original_json = record.toJsonObject(),
            record_modified_json = record_modified.toJsonObject();
