...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define([
      ...
      'requirejs-plugins/src/json!../../resources/legal-term-options-schema.json'
    ], factory);
    ...
    module.exports = factory(
      ...
      require('../../resources/legal-term-options-schema.json')
    );
  }
  
}(this, factory));

function factory(Promise, Object, shim_array, jjv, jjve, utils, schema)
{
      ...
      factory: function(options)
      {
        ...
        function findLexicon(fields, results)
        {
          ...
          if (!field) {
            ...
            if (options.useCache === true && cache.hasOwnProperty(term)) {
        ...
        finto_client = fintoClientFactory(options.finto);
