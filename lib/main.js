...
(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    define([
      ...
      './validators/sort-tag',
      './validators/identical-field-eliminator',
      './validators/udk-version-fenni',
      './validators/return-link-fields'
    ], factory);
  } else if (typeof module === 'object' && module.exports) {
    module.exports = factory(
      require('@natlibfi/marc-record-validate'),
      ...
      require('./validators/identical-field-eliminator'),
      require('./validators/udk-version-fenni'),
      require('./validators/return-link-fields')
    );
  }
